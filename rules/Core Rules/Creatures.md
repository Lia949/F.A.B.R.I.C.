...
The DM can also decide to not let them roll and simply use their level as a Difficulty of player checks (DC). For strength use 4/3 times the level, for weaknesses use 2/3 of the level.

| Creature Level | Number of strenghts | Fixed DC strength | Fixed DC weakness |
| -------------- | ------------------- | ----------------- | ----------------- |
| 1              | 1                   | 2                 | 0                 |
| 2              | 1                   | 3                 | 1                 |
| 3              | 2                   | 4                 | 2                 |
